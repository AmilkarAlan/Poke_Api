      ...
      { !loaded ? <Esqueleto /> :
        (<>
          ...
          <div className="flex flex-col justify-center items-center">
            <p className="text-gray-500 mt-4"><span>#</span>{ `${poke.id.toString().padStart(4, '0')}` }</p> {/* convertimos a string y añadimos padStart para que sea una cadena de 4 caracteres, en caso de tener menos agrega 0 al inicio para completar, 1, 0001, añade 3 para completar la cadena de 4 con el 1*/ }
